...
#endif
#include "logthread.h"                                      //‘logThread’ was not declared in this scope
#if 0
...
*/
    QString customUserAgent; /* julyhttp.cpp:80:9 */
    QString customCookies; /* julyhttp.cpp:102:20 */
    bool gzipEnabled;       /* julyhttp.cpp:88:20 */
/*
    ...
    */
    int apiDownCount;    /* julyhttp.cpp:239:60: error: ‘struct BaseValues’ has no member named ‘apiDownCount’*/
    /*
    int uiUpdateInterval;
    QByteArray depthCountLimitStr;
    int depthCountLimit;
*/
    int httpRetryCount; //julyhttp.cpp:711:47: error: ‘struct BaseValues’ has no member named ‘httpRetryCount’
...
/*
    ...
    */
    QString exchangeName; //exchange.cpp//
    /*
    QString timeFormat;
