...
IndicatorEngine::IndicatorEngine() : QObject()
{
    ...
    //connect(this, &IndicatorEngine::indicatorHighChanged, dialog, dialog::setValueSlot);
    //connect(this, &IndicatorEngine::indicatorHighChanged, baseValues.mainWindow_, &IndicatorEngine::setValueSlot);
